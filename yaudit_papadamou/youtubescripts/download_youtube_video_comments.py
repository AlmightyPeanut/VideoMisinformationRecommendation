...
if __name__ == "__main__":
    ...
    filename = "%s/%s/%s_comments.json" % (output_dir, videoId, videoId)
    # always create at least an empty file
    write_comments_to_file(filename=filename, jsons=json.loads('{"items": []}'))
